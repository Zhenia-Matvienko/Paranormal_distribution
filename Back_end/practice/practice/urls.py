...
urlpatterns = [
    ...
    path('subjects/nonprivate', NonPrivateSubjectsAPIView.as_view(), name='subject-list-private-false'),
    path('subjects/acceptingGrades', SubjectsAcceptingGradesAPIView.as_view(), name='subject-list-acceptGrades-true'),
