...
SECRET_KEY = 'django-insecure-=0he*a8ez5j678+9txcix2a!y6270l16smh-emgk6^b9+$g12+'
...
AUTH_USER_MODEL = 'distribution.CustomUser'
...
DJOSER = {
    'SERIALIZERS': {
        'user_create': 'distribution.serializers.UserCreateSerializer',
...
CORS_ORIGIN_WHITELIST = [
    'http://paranormal-distribution.zzz.com.ua',
]